...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-2 dashside bg-dark p-4">
                <ul class="p-0">
                    <li class="d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="white" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                    ...
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-file-earmark-diff-fill" viewBox="0 0 16 16">
                        ...
                        <a href="/uploadvoucher">Upload Fee Voucher</a>
                    </li>
                    <li>
